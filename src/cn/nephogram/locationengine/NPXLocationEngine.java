...
import cn.nephogram.locationengine.stepdetector.NPStepDector.PMStepListener;
...
public class NPXLocationEngine implements RangingListener, PMStepListener {
	...
	public void onBeaconsDiscovered(Region region, List<Beacon> beacons) {
		...
		for (Beacon b : scannedBeacons) {
			NPXScannedBeacon sb = new NPXScannedBeacon(b.getProximityUUID(),
					b.getMajor(), b.getMinor(), b.getRssi(),
