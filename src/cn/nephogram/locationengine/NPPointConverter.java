...
public class NPPointConverter {
	static String TAG = "NPPointConverter";

	public static NPPoint3D pointFromData(byte[] data) {

		double x = arr2double(data, 5);
		double y = arr2double(data, 13);
		double z = arr2double(data, 21);

		return new NPPoint3D(x, y, z);
	}

	public static byte[] dataFromPoint3D(NPPoint3D point) {
