...
import cn.nephogram.ibeacon.sdk.internal.UnsignedInteger;
import cn.nephogram.ibeacon.sdk.internal.UnsignedLong;
import cn.nephogram.ibeacon.sdk.internal.UnsignedLongs;
...
public class AuthMath {
	...
	public static long randomUnsignedInt() {
		return UnsignedInteger.fromIntBits(RANDOM.nextInt(2147483646))
				.longValue() + 1L;
	}
	...
	static long modExpWithBaseAsLong(long base, long exp, long mod) {
		return UnsignedInteger.fromIntBits(modExpWithBase(base, exp, mod))
				.longValue();
	}
